    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('users.store') }}">
            ...
            <div class="mt-4">
                ...
                {{-- <x-jet-input id="role" class="block w-full mt-1" type="text" name="role" required /> --}}
            ...
            <div class="mt-4">
                ...
                {{-- <x-jet-input id="department" class="block w-full mt-1" type="text" name="department" required /> --}}

<nav x-data="{ open: false }" class="bg-red-700 border-b-2 border-yellow-400">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('sgetype') }}" :active="request()->routeIs('sgetype')">
                        {{ __('SGE Types') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                        {{ __('Student Data') }}
            ...
            <div class="flex items-center -mr-2 sm:hidden">
                <button @click="open = ! open"
                    class="inline-flex items-center justify-center p-2 text-white transition rounded-md ">
